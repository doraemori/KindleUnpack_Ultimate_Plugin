...
class ConfigWidget(QWidget):
    ...
    def __init__(self, plugin_action):
        ...
        # --- ZIP mod Options ---
        zip_mod_group_box = QGroupBox('ZIP mod settings:', self)
        ...
        zip_mod_combo_label = QLabel('Select zip compress type:', self)
        zip_mod_group_box_layout.addWidget(zip_mod_combo_label)
        self.zip_compress_type_combobox = QComboBox()
        self.zip_compress_type_combobox.setToolTip('<p>Select the type of zip compress.')
        zip_mod_group_box_layout.addWidget(self.zip_compress_type_combobox)
        self.zip_compress_type_combobox.addItems(['STORE', 'DEFLATE'])
        ...
        # Directory path Textbox
        # Load the textbox with the current preference setting
        kindle_directory_label = QLabel('Kindle Content Directory:', self)
        ...
        self.kindle_directory_txtBox.setToolTip('<p>Kindle Content directory.')
        zip_mod_group_box_layout.addWidget(self.kindle_directory_txtBox)
        self.kindle_directory_txtBox.setReadOnly(True)

        # Folder select button
        kindle_directory_button = QPushButton('Select/Change Kindle Content Directory', self)
        kindle_directory_button.setToolTip('<p>Select/Change Kindle Content directory.')
        # Connect button to the getDirectory function
        ...
        self.delete_temp_files = QCheckBox('Always delete temporary files', self)
        self.delete_temp_files.setToolTip('<p>When checked... Delete temporary files at end of unpack.')
    ...
    def save_settings(self):
        # Save current dialog sttings back to JSON config file
            ...
            # ZIP mod
            if text_type(self.zip_compress_type_combobox.currentText()) == 'STORE':
    ...
    def getDirectoryKindleContent(self):
        c = choose_dir(self, PLUGIN_NAME + 'dir_chooser',
                'Select Kindle Content Directory')
        if c:
